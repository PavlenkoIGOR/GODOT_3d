...
public partial class PlayerMain : CharacterBody3D
{
    ...
    public override void _Ready()
    {
        ...
        Fire_Anim = GetNode<AnimationPlayer>("Fire_Anim");
    ...
    public void FireingMethod()
    {
        ...
        else
        {
            if (_is_Fireing)
            {
                //Animation animation_StaffFire = new Animation();
                //staff_.FireingStaff_Anim.Play("StopFire_Staff");
                Fire_Anim.PlayBackwards("Fire");
                _is_Fireing = false;
            }
        }
